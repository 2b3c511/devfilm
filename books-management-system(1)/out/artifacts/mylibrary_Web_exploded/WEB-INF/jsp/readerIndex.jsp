...
<div class="layui-layout layui-layout-admin">
	...
	<div class="demoTable layui-form">
	  	<div class="layui-inline">
	    	<input class="layui-input" name="reader_id" id="reader_id" autocomplete="off"  placeholder="请输入用户ID">
	    </div>
	    <div class="layui-inline">
