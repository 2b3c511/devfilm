...
<body>
    ...
    <div class="layui-logo">嘉禾影院系统</div>
    <!-- 头部区域（可配合layui已有的水平导航） -->
    <ul class="layui-nav layui-layout-left">
      <li class="layui-nav-item">
        <a href="javascript:;">影片管理</a>
        <dl class="layui-nav-child">
          <dd><a href="<%=basePath%>index.action">影片列表</a></dd>
          <dd><a href="<%=basePath%>library/bookType.action">分类管理</a></dd>
        </dl>
      </li>
        <li class="layui-nav-item"><a href="<%=basePath%>readerIndex.action">用户列表</a></li>
        <li class="layui-nav-item"><a href="<%=basePath%>listDisBackAdmin.action">记录管理</a></li>
    ...
    <ul class="layui-nav layui-layout-right">
      ...
      <li class="layui-nav-item"><a href="<%=basePath%>loginout.action">退出登录</a></li>
    </ul>
  </div>
