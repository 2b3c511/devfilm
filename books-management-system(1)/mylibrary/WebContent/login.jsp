...
<body style="background:url(<%=basePath%>images/face/timg.jpg);background-size:100%100%;background-attachment: fixed">
 
<div class="login-main">
    <header class="layui-elip">嘉禾票务系统登录</header>
