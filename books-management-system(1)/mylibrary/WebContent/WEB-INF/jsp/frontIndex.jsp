...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="demoTable layui-form">
        ...
        <div class="layui-inline">
            <input class="layui-input" name="author" id="author" autocomplete="off" placeholder="请输入导演">
        </div>
        <div class="layui-inline">
...
<script type="text/html" id="barDemo">
    <%-- 必须使用 button--%>
    <button class="layui-btn layui-btn-normal layui-btn-sm lend" lay-event="lend">购买</button>
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element', 'slider'], function () {
        ...
        table.render({
            ...
            , cols: [[ //表头
                ...
                , {field: 'book_id', title: '影片编号', width: 150, sort: true}
                , {field: 'name', title: '电影名', width: 200}
                , {field: 'author', title: '导演', width: 200, sort: true}
                , {field: 'publish', title: '出版方', width: 200, sort: true}
              /*  , {field: 'ISBN', title: 'ISBN', width: 150, sort: true}*/
                , {field: 'pubdate', title: '上映日期', width: 120, sort: true}
                , {field: 'stock', title: '座位剩余', width: 100}
        ...
        table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'lend') {
                layer.confirm('确认购买此电影吗?', function (index) {
                    lend(obj, index, data);
                });
            }
        });
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data == '1') {
                        ...
                        layer.msg('您已经买过影片!', {icon: 5});
                    }else if (data == '3') {
                        layer.msg('您已经达到上限!', {icon: 5});
                    }else{
                        layer.msg('座位不足!', {icon: 5});
                    }
                }
            })
