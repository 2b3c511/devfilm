...
<%-- 		<fmt:formatDate value="${test}" pattern="yyyy-MM-dd"/>  --%>
   ...
   <div class="layui-form-item">
   <div class="layui-inline">
      <label class="layui-form-label">出版方：</label>
      <div class="layui-input-inline">
   ...
   <div class="layui-form-item">
	 <div class="layui-inline">
      <label class="layui-form-label">座位剩余：</label>
      <div class="layui-input-inline">
  ...
  <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-block">
      <textarea style="width:600px; height:150px" placeholder="输入影片描述" name="introduction"  lay-verify="required"  class="layui-textarea">${bookinfo.introduction}</textarea>
    </div>
  </div>
  <div class="layui-form-item">
    <div class="layui-input-block">
